function [levels]=monotonicPEX(Nbit,Vdd,Vss,C,kc,cspec,cbridge,Cpar11,Cpar12,Cpar21,Cpar22,STP,SBP,STBP,PEX11,PEX12,PEX21,PEX22,PEXB)
...
%total array capacitance NOT ioncluding PPEX parasitics
CA2tot_nom=sum(CA2);
CA1tot_nom=sum(CA1);
...
%total array capacitance ioncluding PPEX parasitics
CA2tot=sum(CA2);
CA1tot=sum(CA1);
